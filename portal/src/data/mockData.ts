...
export const seedTasks: Task[] = [
  ...
  },
  {
    ...
    ownerId: 'u_lead',
    assigneeId: 'u_staff',
    title: 'Code review: portal scaffolding PR',
    status: 'in_progress',
    priority: 'high',
    category: 'react',
    dueDate: isoToday(0),
...
export const seedWorkspaceNotes: WorkspaceNote[] = [
  {
    ...
    blocks: [
      ...
      { id: 'b_sp_4', type: 'todo', text: 'Review portal PRs', checked: false },
    ],
    parentId: null,
    iconEmoji: '📝',
    ownerId: 'u_lead',
...
export const seedCheckIns: WeeklyCheckIn[] = [
  {
    ...
    completed: 'Shipped the careers page redesign. Reviewed 4 PRs.',
    nextWeek: 'Start portal Phase 1, mentor Chioma on her first PR.',
    blockers: 'None',
    hoursWorked: 38,
